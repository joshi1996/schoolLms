...
public class PaymentsUtil {
     ...
     * environment and theme set in
     *
     * @param activity is the caller's activity.
     */
    public static PaymentsClient createPaymentsClient(Activity activity) {
        Wallet.WalletOptions walletOptions =
                new Wallet.WalletOptions.Builder().setEnvironment(GooglePayConstant.PAYMENTS_ENVIRONMENT).build();
    ...
    private static JSONObject getDirectTokenizationSpecification()
        ...
        if (GooglePayConstant.DIRECT_TOKENIZATION_PARAMETERS.isEmpty()
                || GooglePayConstant.DIRECT_TOKENIZATION_PUBLIC_KEY.isEmpty()
                || GooglePayConstant.DIRECT_TOKENIZATION_PUBLIC_KEY == null
                || GooglePayConstant.DIRECT_TOKENIZATION_PUBLIC_KEY == "REPLACE_ME") {
        ...
        JSONObject parameters = new JSONObject(GooglePayConstant.DIRECT_TOKENIZATION_PARAMETERS);
    ...
    private static JSONArray getAllowedCardNetworks() {
        return new JSONArray(GooglePayConstant.SUPPORTED_NETWORKS);
    }
    ...
    private static JSONArray getAllowedCardAuthMethods() {
        return new JSONArray(GooglePayConstant.SUPPORTED_METHODS);
    }
    ...
    private static JSONObject getTransactionInfo(String price) throws JSONException {
        ...
        transactionInfo.put("countryCode", GooglePayConstant.COUNTRY_CODE);
        transactionInfo.put("currencyCode", GooglePayConstant.CURRENCY_CODE);
    ...
    public static Optional<JSONObject> getPaymentDataRequest(long priceCents) {
      ...
      JSON object. */
            ...
            JSONArray allowedCountryCodes = new JSONArray(GooglePayConstant.SHIPPING_SUPPORTED_COUNTRIES);
